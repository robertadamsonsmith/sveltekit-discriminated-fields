...
<p>Test discriminated union forms with:</p>
<ul>
	<li><a href="/zod-form">Zod schema</a> (select element)</li>
	<li><a href="/valibot-form">Valibot schema</a> (select element)</li>
	<li><a href="/radio-form">Radio buttons</a> (radio input elements)</li>
	<li><a href="/selector-form">Selector prop</a> (non-sibling select layout)</li>
